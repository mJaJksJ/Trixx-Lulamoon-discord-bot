    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "IsReadOnly", "Name", "NormalizedName", "Permissions" },
                values: new object[] { 1, "c5b18af4-d272-4ee8-ac25-0009b9097533", true, "Администратор", "АДМИНИСТРАТОР", "[0]" });
